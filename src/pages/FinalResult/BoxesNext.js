...
export default function BoxesNext() {
    return (
        <>
            <section className="page-section" style={{ marginTop: '10%' }}>

                <div className="content-wrapper position-relative" style={{ textAlign: "center" }}>
                    <div className="content">
                        <div data-fluid-engine="true">
                            <p style={{ textAlign: 'center' }}>What Next?</p>
                            <h3>Next Steps...</h3>
                            <p>We’ve helped THOUSANDS of homeowners like you, switch to save money & save the environment.</p>
