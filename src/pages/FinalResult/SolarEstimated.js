                    ...
                    <div className="container-fluid"
                        ...
                        <div className="row" style={{ padding: '20px' }}>
                            <div className="col-12">
                                <img src={'assets/content/final_solarsystem.png'}
                                ...
                                <div className="col-md-6 mb-4">
                                    <div className="info-box d-flex align-items-center"
                                        ...
                                        <div>
                                            ...
                                            <h5 style={{ color: '#2b2e4a', fontWeight: '700', marginBottom: '8px', textAlign: 'left' }}><strong>US Tonnes of CO2 <br />
                                ...
                                <div className="col-md-6 mb-4">
                                    <div className="info-box d-flex align-items-center"
                                        ...
                                        <div>
                                            ...
                                            <h5 style={{ color: '#2b2e4a', fontWeight: '700', marginBottom: '8px', textAlign: 'left' }}><strong>Total Electricity Cost <br />
